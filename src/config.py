...
SCRAPE_CLASS_PARTICIPANTS_MAX_CLASSES   = 1         # Maximum number of classes to scrape participants from, set to 0 for all classes
SCRAPE_CLASS_PARTICIPANTS_CLASS_ID_EXT  = None      # Set to None to scrape all 25092
SCRAPE_CLASS_PARTICIPANTS_ORDER         = "oldest"  # Order of classes to scrape participants from, "oldest" or "newest"