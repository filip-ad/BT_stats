...
SCRAPE_LICENSES_RUN_ORDER           = "newest"  # Order of seasons to scrape, "oldest" or "newest"

SCRAPE_RANKINGS_NBR_OF_RUNS         = 1         # How many rankings runs to scrape, 0 for all runs
SCRAPE_RANKINGS_RUN_ORDER           = "newest"  # Order of ranking runs to scrape, "oldest" or "newest"
...
SCRAPE_TRANSITIONS_RUN_ORDER        = "newest"  # Order of seasons to scrape, "oldest" or "newest"