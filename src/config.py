...
SCRAPE_TOURNAMENTS_CUTOFF_DATE          = "2025-09-01"  # Date format: YYYY-MM-DD
...
SCRAPE_PARTICIPANTS_MAX_CLASSES         = 1000                  # Maximum number of classes to scrape participants from, None for all classes
